...
class JobsList::EditFeature < ParagraphFeature


  feature :jobs_list_edit_list, :default_feature => <<-FEATURE
  ...
  def jobs_list_edit_list_feature(data)
    webiva_feature(:jobs_list_edit_list) do |c|
  ...
  feature :jobs_list_edit_write, :default_feature => <<-FEATURE
    <cms:post>
      <cms:errors>
      <div class='error'>
      There was a problem saving your jobs_list:<br/>
      <cms:value/>
      </div>
      </cms:errors>
  ...
  def jobs_list_edit_write_feature(data)
    webiva_feature(:jobs_list_edit_write) do |c|
